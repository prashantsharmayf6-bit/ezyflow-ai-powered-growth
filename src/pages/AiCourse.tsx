  ...
  <div>
    ...
    <section className="hero-dark pt-16">
      <div className="container mx-auto px-4 py-24 md:py-36">
        <div className="mx-auto max-w-3xl text-center">
          <div className="mb-6 inline-flex items-center gap-2 rounded-full border border-accent/30 px-4 py-1.5 text-sm text-accent">
            <Clock className="h-4 w-4" /> Limited Seats Available
          </div>
          <h1 className="mb-6 text-4xl font-extrabold text-hero-foreground md:text-6xl">
          ...
          <div className="mt-8 flex items-center justify-center gap-6 text-sm text-hero-muted">
    ...
    <SectionWrapper dark>
      <div className="mx-auto mb-14 max-w-2xl text-center">
        <h2 className="mb-4 text-3xl font-bold text-hero-foreground">Course Breakdown</h2>
      </div>
      <div className="mx-auto grid max-w-3xl gap-4">
        {modules.map((m) => (
          <div key={m.title} className="glass-card flex items-start gap-4 rounded-xl p-6">
            ...
            <div>
              <h3 className="font-semibold text-hero-foreground">{m.title}</h3>
              <p className="text-sm text-hero-muted">{m.desc}</p>
            </div>
          </div>
        ))}
      </div>
    ...
    <SectionWrapper dark>
      <div className="mx-auto max-w-lg text-center">
        <h2 className="mb-4 text-3xl font-bold text-hero-foreground">Invest in Your Future</h2>
        <div className="glass-card rounded-2xl p-10">
          <div className="mb-2 text-sm text-hero-muted line-through">₹9,999</div>
          ...
          <ul className="mb-8 space-y-3 text-left">
            {["Full course access", "Real-world projects", "Ezyflow Certification", "Lifetime access to materials", "Community access"].map((f) => (
              <li key={f} className="flex items-center gap-3 text-sm text-hero-muted">
